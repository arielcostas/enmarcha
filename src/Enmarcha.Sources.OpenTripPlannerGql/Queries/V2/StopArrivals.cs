...
public class StopArrivalsContent : IGraphRequest<StopArrivalsContent.Args>
{
    public record Args(string Id, bool LoadGeometry = false);
...
public class StopArrivalsResponse : AbstractGraphResponse
{
    ...
    public class TripDetails
    {
        ...
        [JsonPropertyName("directionId")] public required string DirectionId { get; set; }
    ...
    public class StoptimeDetails
    {
        ...
        public int ScheduledAt => ScheduledDeparture ?? ScheduledArrival ?? 0;
    }
